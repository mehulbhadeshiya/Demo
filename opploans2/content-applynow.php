  ...
  <div class=page--wrap>
    <a class='hide' href='#header' id='header'></a>
      ...
      ' id='loan-amount' name='loan-amount' type='text' value='2500'>
            ...
            <div class=ph+>
            <a class='apply-now button' href='/facebook-marketing'>
              Apply Online
            </a>
          </div>
        ...
        <div class='grid__item'>
          <ul class='numbers menu vertical menu-centered text-center flexVerticalCenter'>
            ...
            <li class='two'>
              ...
              <h6>You're approved, details verified, now let's make it official.</h6>
            </li>
            <li class='three'>
              <h5>Receive Your OppLoan.</h5>
              <h6>Accept your money and get going!</h6>
            </li>
          </ul>
        </div>
        <div class='grid__item'>
